...
const en = {
  ...
  // Compare page
  compare_title: 'Current Site vs. This Concept',
  compare_sub: 'What this redesign adds on top of albaik.com today.',
  cmp_now: 'Today',
  cmp_concept: 'This concept',
  cmp_1_t: 'True bilingual experience',
  cmp_1_now: 'Language switch reloads the page; layout stays left-to-right.',
  cmp_1_new: 'Instant EN/AR toggle with a fully mirrored right-to-left layout and native Arabic typography.',
  cmp_2_t: 'Interactive menu',
  cmp_2_now: 'A static photo grid with item names only.',
  cmp_2_new: 'Searchable, filterable menu with categories, spicy filter, calorie sorting, and per-item nutrition — in both languages.',
  cmp_3_t: 'Branch finder',
  cmp_3_now: 'A plain text list of branches.',
  cmp_3_new: 'Filterable branch cards with city, services, and hours at a glance.',
  cmp_4_t: 'Brand storytelling',
  cmp_4_now: 'Two paragraphs of history on the homepage.',
  cmp_4_new: 'An animated 50-year timeline that treats the 1974 story as the treasure it is.',
  cmp_5_t: 'Modern foundation',
  cmp_5_now: 'Server-rendered pages with minimal interactivity.',
  cmp_5_new: 'A fast, accessible, mobile-first experience: keyboard navigation, reduced-motion support, and instant page transitions.',
...
const ar: Record<TranslationKey, string> = {
  ...
  compare_title: 'الموقع الحالي مقابل هذا التصور',
  compare_sub: 'ما الذي يضيفه هذا التصميم الجديد على موقع albaik.com الحالي.',
  cmp_now: 'اليوم',
  cmp_concept: 'هذا التصور',
  cmp_1_t: 'تجربة ثنائية اللغة حقيقية',
  cmp_1_now: 'تبديل اللغة يعيد تحميل الصفحة، ويبقى التصميم من اليسار إلى اليمين.',
  cmp_1_new: 'تبديل فوري بين العربية والإنجليزية مع انعكاس كامل للتصميم من اليمين إلى اليسار وخطوط عربية أصيلة.',
  cmp_2_t: 'قائمة تفاعلية',
  cmp_2_now: 'شبكة صور ثابتة بأسماء الأصناف فقط.',
  cmp_2_new: 'قائمة قابلة للبحث والتصفية مع فئات وفلتر للأصناف الحارة وترتيب حسب السعرات ومعلومات غذائية لكل صنف — باللغتين.',
  cmp_3_t: 'مستكشف الفروع',
  cmp_3_now: 'قائمة نصية بسيطة بالفروع.',
  cmp_3_new: 'بطاقات فروع قابلة للتصفية حسب المدينة مع الخدمات وساعات العمل في لمحة.',
  cmp_4_t: 'سرد قصة العلامة',
  cmp_4_now: 'فقرتان عن التاريخ في الصفحة الرئيسية.',
  cmp_4_new: 'خط زمني متحرك لخمسين عامًا يعامل قصة ١٩٧٤ ككنز يستحق أن يُروى.',
  cmp_5_t: 'أساس تقني حديث',
  cmp_5_now: 'صفحات بسيطة بحد أدنى من التفاعل.',
  cmp_5_new: 'تجربة سريعة وسهلة الوصول تبدأ من الجوال: تنقّل بلوحة المفاتيح، ودعم تقليل الحركة، وانتقالات فورية بين الصفحات.',
